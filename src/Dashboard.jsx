    ...
    <div className="min-h-0 flex flex-col items-center justify-center px-4 py-8 text-center">
      <div className="w-full max-w-2xl space-y-8">
        ...
        <div className="space-y-4">
          <h2 className="text-4xl font-semibold text-text">No Translations Yet</h2>
          <p className="text-lg leading-8 text-text/70">
            Looks like you don't have any translations yet. How about try to upload and translate some of your stuff?
          </p>
        </div>
        <button
          onClick={onCreate}
