  ...
  return (
    <div className="w-full space-y-6 pb-16 sm:space-y-8">
      <div className="w-full space-y-3 sm:space-y-4">
        ...
        <p className="text-base text-text/70 sm:text-lg">{t('terms.description')}</p>
      </div>
      ...
      <div className="w-full space-y-5 sm:space-y-8">
        ...
        <div className="w-full overflow-hidden rounded-[1.5rem] border border-white/10 bg-background/50 p-4 text-xs text-text/60 sm:mt-8 sm:p-6 sm:text-sm">
          {t('terms.lastUpdated')}
        </div>
      </div>
    </div>
